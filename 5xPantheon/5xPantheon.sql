...
--This Mod modifies the effect of the pantheon in the game, making them 5 times as effective.
...
--This mod is attached to http://steamcommunity.com/sharedfiles/filedetails/?id=938733933&tscn=1501356605
--That's means If this needs to be updated, I'll update it 10x first.
...
--Aug 1,2017 V1 Base:V4
--upload.

--Aug 1,2017 V2 Base:V4
--Check & Publish.

--Aug 1,2017 V3 Base:V4
--synchronization.

--Dec 9,2017 V4 Base:V5
--Add 2 new pantheons and fix bugs.

--Apr 25,2021 V5 Base:V8
--Rebuild.
