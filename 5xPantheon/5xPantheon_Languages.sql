...
update LocalizedText
set Text = replace(Text,'25','125')
where Tag = 'LOC_BELIEF_GOD_OF_THE_FORGE_DESCRIPTION';

--initiation rites  17

update LocalizedText
set Text = replace(Text,'50','250')
...
update LocalizedText
set Text = replace(Text,'30','150')
where Tag = 'LOC_BELIEF_GOD_OF_HEALING_DESCRIPTION';

--feritlity rites 20

update LocalizedText
set Text = replace(Text,'10','50')
...
update LocalizedText
--set Text = Text || '(x10)'
set Text = replace(Text,'[ICON_Faith]',' 500% [ICON_Faith]')
