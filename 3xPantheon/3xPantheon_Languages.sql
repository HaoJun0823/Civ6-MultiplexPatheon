...
update LocalizedText
set Text = replace(Text,'30','90')
where Tag = 'LOC_BELIEF_GOD_OF_HEALING_DESCRIPTION';

--feritlity rites 20

update LocalizedText
set Text = replace(Text,'10','30')
...
update LocalizedText
--set Text = Text || '(x10)'
set Text = replace(Text,'[ICON_Faith]',' 300% [ICON_Faith]')
